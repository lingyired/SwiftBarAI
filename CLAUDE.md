...
- **五种插件类型**：
  ...
  - `EphemeralPlugin` — 通过 `menubar01://setephemeralplugin` URL 临时展示的菜单项（兼容旧 `swiftbar://setephemeralplugin`）
...
MENUBAR01_PLUGIN_CACHE_PATH, MENUBAR01_PLUGIN_DATA_PATH, MENUBAR01_PLUGIN_REFRESH_REASON,
